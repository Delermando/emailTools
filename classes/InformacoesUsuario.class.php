...
class obterInformacoes{
    ...
    function geolocalizacaoInformation($ip){
        ...
        eval('$array = '.$array.';');
//        unset($array['geoplugin_request'], 
//            $array['geoplugin_status'], 
//            $array['geoplugin_credit'], 
//            $array['geoplugin_areaCode'], 
//            $array['geoplugin_dmaCode'],
//            $array['geoplugin_countryCode'],
//            $array['geoplugin_regionCode'],
//            $array['geoplugin_currencyCode'],
//            $array['geoplugin_currencySymbol'],
//            $array['geoplugin_currencySymbol_UTF8'],
//            $array['geoplugin_currencyConverter']
//        );
//        
        $arrayretorno = array(
            'geoplugin_city' => 0, 
            'geoplugin_region' => 0,
            'geoplugin_countryName' => 0,
            'geoplugin_continentCode' => 0,
            'geoplugin_latitude' => 0,
            'geoplugin_longitude' => 0,
            'geoplugin_regionName' => 0
        ); 
        
        $keys = array_keys($arrayretorno);
        for($a=0; sizeof($arrayretorno) > $a; $a++){
            if(isset($array[$keys[$a]]) && $array[$keys[$a]] != null){
                $arrayretorno[$keys[$a]] = $array[$keys[$a]]; 
            }
         }
        return $arrayretorno;
    }
